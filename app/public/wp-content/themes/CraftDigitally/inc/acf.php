...
add_action('acf/init', function () {
  ...
  acf_add_local_field_group(array(
    ...
    'fields' => array(
      ...
      craftdigitally_acf_wrap(craftdigitally_acf_image_field('blog_detail_author_avatar', 'blog_detail_author_avatar', 'Author Photo'), 50),
      craftdigitally_acf_wrap(craftdigitally_acf_image_field('blog_detail_author_social_image', 'blog_detail_author_social_image', 'Author Social Links Image (legacy)'), 50),
      ...
      craftdigitally_acf_wrap(craftdigitally_acf_url_field('blog_detail_author_linkedin_url', 'blog_detail_author_linkedin_url', 'Author LinkedIn URL'), 50),
      craftdigitally_acf_wrap(craftdigitally_acf_url_field('blog_detail_author_x_url', 'blog_detail_author_x_url', 'Author X (Twitter) URL'), 50),
      craftdigitally_acf_wrap(craftdigitally_acf_url_field('blog_detail_author_facebook_url', 'blog_detail_author_facebook_url', 'Author Facebook URL'), 50),
      craftdigitally_acf_wrap(craftdigitally_acf_url_field('blog_detail_author_instagram_url', 'blog_detail_author_instagram_url', 'Author Instagram URL'), 50),
    ),
    'location' => craftdigitally_acf_location_template_or_pages(
