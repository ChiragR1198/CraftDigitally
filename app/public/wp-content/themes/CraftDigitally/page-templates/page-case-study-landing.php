<?php
/**
 * Template Name: Case Study Landing Page
...
$cd_cs_hero_title = craftdigitally_get_acf('cs_landing_hero_title', 'Driving Growth Through SEO:<br />Client Success Stories');
$cd_cs_hero_subtitle = craftdigitally_get_acf('cs_landing_hero_subtitle', "Discover how we've helped businesses improve rankings, increase traffic, and turn clicks into customers.<br />Through strategic SEO campaigns, we've guided clients from low visibility to top search positions");
...
// Featured Case Study - Default ACF values (fallback)
$cd_cs_featured_logo = craftdigitally_get_acf_image_url('cs_landing_featured_logo', get_template_directory_uri() . '/assets/images/testeracademy.png');
$cd_cs_featured_title = craftdigitally_get_acf('cs_landing_featured_title', 'Top 3 Rankings for competitive keywords');
$cd_cs_featured_desc = craftdigitally_get_acf('cs_landing_featured_desc', 'A leading [industry/business type] client was struggling to rank for highly competitive keywords that their target audience searched daily. Despite quality services, they remained invisible beyond page 5 of Google.');
$cd_cs_featured_btn_label = craftdigitally_get_acf('cs_landing_featured_button_label', 'Read Case Study');
$cd_cs_featured_btn_url = craftdigitally_get_acf('cs_landing_featured_button_url', '#');
...
if ($cd_cs_posts_q->have_posts()) {
  ...
  // Get featured logo from ACF (prioritize ACF field, then featured image, then default)
  ...
  // If ACF field is empty, use page-level ACF as fallback
  if (empty($cd_cs_featured_logo) || $cd_cs_featured_logo === (get_template_directory_uri() . '/assets/images/testeracademy.png')) {
    $cd_cs_featured_logo = craftdigitally_get_acf_image_url('cs_landing_featured_logo', get_template_directory_uri() . '/assets/images/testeracademy.png');
  }
}

$cd_cs_results_title = craftdigitally_get_acf('cs_landing_results_title', 'Results Our Clients Have Achieved');
$cd_cs_results_subtitle = craftdigitally_get_acf('cs_landing_results_subtitle', "Our SEO strategies go beyond rankings — they deliver measurable business growth.<br />From higher visibility to increased traffic and leads, see how our clients turned searches into success.");
$cd_cs_results_count = (int) craftdigitally_get_acf('cs_landing_results_count', 6);
$cd_cs_results_read_more = craftdigitally_get_acf('cs_landing_results_read_more_label', 'Read Full Story');
$cd_cs_view_all_label = craftdigitally_get_acf('cs_landing_view_all_label', 'View all Case Studies');
$cd_cs_view_all_url = craftdigitally_get_acf('cs_landing_view_all_url', '#');

$cd_cs_test_heading = craftdigitally_get_acf('cs_landing_testimonial_heading', 'What Clients Say About Working With Us');
$cd_cs_test_quote = craftdigitally_get_acf('cs_landing_testimonial_quote', "Before working with CraftDigitally, SEO felt like a fog I couldn't navigate. Their process made everything so clear and actionable. I left with not only a visible online presence but a genuine sense of confidence");
$cd_cs_test_avatar = craftdigitally_get_acf_image_url('cs_landing_testimonial_avatar', get_template_directory_uri() . '/assets/images/sarah-lin.png');
$cd_cs_test_name = craftdigitally_get_acf('cs_landing_testimonial_name', 'Sarah Lin');
$cd_cs_test_role = craftdigitally_get_acf('cs_landing_testimonial_role', 'Brand Strategist, Lin Studio');

$cd_cs_cta_title = craftdigitally_get_acf('cs_landing_cta_title', 'Ready to Dominate Your Competition?');
$cd_cs_cta_subtitle = craftdigitally_get_acf('cs_landing_cta_subtitle', 'Craft Digitally transformed our online presence completely. Our website now ranks on the first page for our target keywords, and our business has grown significantly. Their SEO expertise is unmatched in Ahmedabad');
$cd_cs_cta_name_ph = craftdigitally_get_acf('cs_landing_cta_name_placeholder', 'Name');
$cd_cs_cta_phone_ph = craftdigitally_get_acf('cs_landing_cta_phone_placeholder', 'Phone');
$cd_cs_cta_email_ph = craftdigitally_get_acf('cs_landing_cta_email_placeholder', 'Email');
$cd_cs_cta_service_ph = craftdigitally_get_acf('cs_landing_cta_service_placeholder', 'Service');
$cd_cs_cta_message_ph = craftdigitally_get_acf('cs_landing_cta_message_placeholder', 'Message');
$cd_cs_cta_submit = craftdigitally_get_acf('cs_landing_cta_submit_label', "Let's Connect");
?>
