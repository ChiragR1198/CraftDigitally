...
$cd_sl_hero_kicker = craftdigitally_get_acf('service_landing_hero_kicker', 'SEO Services That Help Your Business Get Found - and Chosen');
$cd_sl_hero_subhead = craftdigitally_get_acf('service_landing_hero_subhead', 'With tailored SEO, we make it easier for customers to discover your business and choose you over competitors. Clear strategy, transparent reporting, and measurable results-every step of the way.');

$cd_sl_featured_title = craftdigitally_get_acf('service_landing_featured_title', 'Local SEO That Drives Real Foot Traffic to Your Business');
$cd_sl_featured_desc = craftdigitally_get_acf('service_landing_featured_desc', 'Our Local SEO strategies make it easier for people nearby to discover, trust, and choose your business. From GBP optimization to local ranking boosts, we help you turn searches into walk-ins.');
$cd_sl_featured_btn_label = craftdigitally_get_acf('service_landing_featured_button_label', 'Read Our Services');
$cd_sl_featured_btn_link = craftdigitally_get_acf('service_landing_featured_button_link', '#services');
$cd_sl_featured_img = craftdigitally_get_acf_image_url('service_landing_featured_image', get_template_directory_uri() . '/assets/images/service-book.png');
$cd_sl_featured_img_alt = craftdigitally_get_acf('service_landing_featured_image_alt', 'Local SEO Service');

$cd_sl_services_title = craftdigitally_get_acf('service_landing_services_title', 'Our Services');
$cd_sl_services_subtitle = craftdigitally_get_acf('service_landing_services_subtitle', "Whether you're a startup in Chandkheda or an established brand in Prahladnagar, we've got your back. Your Roadmap to More Traffic, Leads & Sales");
...
// Query service posts for landing page
...
$cd_sl_cta_title = craftdigitally_get_acf('service_landing_cta_title', 'Ready to Dominate Your Competition?');
$cd_sl_cta_subtitle = craftdigitally_get_acf('service_landing_cta_subtitle', 'Craft Digitally transformed our online presence completely. Our website now ranks on the first page for our target keywords, and our business has grown significantly. Their SEO expertise is unmatched in Ahmedabad');
$cd_sl_cta_name_ph = craftdigitally_get_acf('service_landing_cta_name_placeholder', 'Name');
$cd_sl_cta_phone_ph = craftdigitally_get_acf('service_landing_cta_phone_placeholder', 'Phone');
$cd_sl_cta_email_ph = craftdigitally_get_acf('service_landing_cta_email_placeholder', 'Email');
$cd_sl_cta_service_ph = craftdigitally_get_acf('service_landing_cta_service_placeholder', 'Service');
$cd_sl_cta_message_ph = craftdigitally_get_acf('service_landing_cta_message_placeholder', 'Message');
$cd_sl_cta_submit = craftdigitally_get_acf('service_landing_cta_submit_label', "Let's Connect");
?>
      ...
      <div class="container-2">
        <div class="right">
          <div class="div-2">
            ...
            <!-- <div class="div-2">
              <div class="frame">
                <div class="local-SEO">LOCAL SEO</div>
                <div class="text-wrapper-3">Featured Service</div>
              </div>
          ...
          <!-- <a href="#services" class="div-wrapper"><div class="text-wrapper-5">Explore All Services</div></a> -->
    ...
    <section class="services-section" id="services">
      <div class="container">
        ...
        <div class="services-grid">
          <?php
          // Display dynamic services from custom post type
          if ($cd_sl_service_posts_q->have_posts()) {
            while ($cd_sl_service_posts_q->have_posts()) {
              ...
              // Get icon from ACF field (prioritize ACF, then featured image, then default)
            ...
            // Fallback to static cards if no posts
